...
#load library
library(dplyr)
options(dplyr.summrise.inform = FALSE)
library(reshape2)
library(openxlsx)
library(car)
library(ggplot2)
...
datgov = read.csv("data/SMU29281409093000001SA.csv")
...
```{r zipdata, warning=FALSE, message = FALSE, echo=FALSE}
...
```{r zip_choropleth, warning=FALSE, message = FALSE, echo=FALSE}
